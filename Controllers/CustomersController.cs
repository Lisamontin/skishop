...
namespace skishop.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public async Task<ActionResult<CustomerDTO>> GetCustomer(int id)
        {
            ...
            Customer found = await _context.Customers.Include(c => c.Orders).FirstAsync(c => c.Id == id);
        ...
        // POST: api/Customers
        [HttpPost]
        public async Task<ActionResult> PostCustomer(CustomerDTO newCustomerDTO)
        {
            ...
            return CreatedAtAction(nameof(PostCustomer), returnValue);
        }
